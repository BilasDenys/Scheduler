...
export const useCalculateFinishEvent = ( startHour: number, startMinutes: number, duration: number ) => {
    ...
    // React.useEffect(() => {
        const calculateFinalResult = ( startHour: number, startMinutes: number, duration: number ): string => {
